...
interface Repository<RAW, NORMAL, DETAILED, PARTIAL_API, COMPLETE_API> {
    ...
    fun raw(id: UUID, libraryId: UUID): RAW
    fun get(id: UUID, libraryId: UUID): DETAILED
    fun getAll(libraryId: UUID, order: SortOrder, limit: Int = 20, offset: Long = 0L): List<NORMAL>
    fun search(query: String, libraryId: UUID): List<NORMAL>
    fun search(query: String): List<NORMAL>
    fun sorting(libraryId: UUID, order: SortOrder, limit: Int = 20, offset: Long = 0L): List<UUID>
