...
internal fun RouteHandler.patchBook(id: BookId, patchBook: PatchBook): BookModel {
    val book = transaction { Book.findById(id.id) } ?: serverError(HttpStatusCode.NotFound, "Book was not found")
    return transaction {
        book.apply {
...
internal fun RouteHandler.postBook(id: BookId, postBook: PostBook): BookModel {
    val book = transaction { Book.findById(id.id) } ?: serverError(HttpStatusCode.NotFound, "Book was not found")
    return transaction {
        book.apply {
