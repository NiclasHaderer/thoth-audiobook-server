...
internal fun RouteHandler.patchAuthor(id: AuthorId, patchAuthor: PatchAuthor): AuthorModel =
    transaction {
      val author =
          Author.findById(id.id) ?: serverError(HttpStatusCode.NotFound, "Author not found")
      author
          .apply {
            ...
            imageID =
                Image.getNewImage(patchAuthor.image, currentImageID = imageID, default = imageID)
          }
          .toModel()
    }

internal fun RouteHandler.postAuthor(id: AuthorId, postAuthor: PostAuthor): AuthorModel =
    transaction {
      val author =
          Author.findById(id.id) ?: serverError(HttpStatusCode.NotFound, "Author not found")
      author
