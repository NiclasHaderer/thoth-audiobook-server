...
fun Routing.bookRouting() {
    ...
    get<Api.Libraries.Books.All, PaginatedResponse<BookModel>> { route ->
        val books =
            bookService.books(
    ...
    get<Api.Libraries.Books.Sorting, List<UUID>> { route ->
    ...
    get<Api.Libraries.Books.Id, DetailedBookModel> { route ->
