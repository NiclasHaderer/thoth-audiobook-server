...
abstract class TsTypeGenerator : TypeGenerator<TsTypeGenerator.TsType, TsTypeGenerator.TsDataType>() {
    ...
    class TsInlineType(override val content: String, name: String?, override val parser: TsParseMethod) : TsType() {
    ...
    enum class TsParseMethod(val methodName: String) {
        BLOB("blob"),
        JSON("json"),
        TEXT("text"),
    }
    ...
    override fun createType(classType: ClassType, generateSubType: GenerateType<TsType>): TsType {
