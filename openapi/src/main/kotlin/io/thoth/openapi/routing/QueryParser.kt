...
fun <T : Any> parseParametersIntoClass(
  ...
  for (parameter in constructor.parameters) {
    ...
    // Every constructor parameter that is not optional has to be decorated as either a path or
    // query parameter
    ...
    // Should the value of the constructor query parameter be read from the query params or the path
    // params
    val parameterSource =
    ...
    // Try to parse the url or query parameter in the constructorCallArgs map, which will get passed
    // on to the
    // primary constructor
    try {
