...
private val RegionMappings =
    mutableMapOf(
        AudibleRegions.au to
            AudibleRegionValue(
                chapterName = audibleChapterName, tld = "com.au", datePattern, titleReplacers),
        AudibleRegions.ca to
            AudibleRegionValue(
                chapterName = audibleChapterName, tld = "ca", datePattern, titleReplacers),
        ...
        AudibleRegions.`in` to
            AudibleRegionValue(
                chapterName = audibleChapterName, tld = "in", datePattern, titleReplacers),
        ...
        AudibleRegions.us to
            AudibleRegionValue(
                chapterName = audibleChapterName, tld = "com", datePattern, titleReplacers),
        AudibleRegions.uk to
            AudibleRegionValue(
                chapterName = audibleChapterName, tld = "co.uk", datePattern, titleReplacers),
    )
